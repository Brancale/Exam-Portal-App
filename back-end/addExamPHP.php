 <?php
	...
	// Data format: delimeter separated Question IDs, semicolon separated answers, Open time in milliseconds, close time
	$jsonData["data"] = "('1|*|2','Hello World!|*|1 1 2 3 5',1543640400000,1545368400000)";
